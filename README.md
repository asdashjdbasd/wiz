...
```
bash <(curl -s https://raw.githubusercontent.com/asdashjdbasd/wiz/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/asdashjdbasd/wiz/main/update.sh)
```
