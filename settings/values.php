...
$mainValues = [
    'banned' => '❌ | شما به علت عدرم رعایت قوانین مسدود شدید در صورت نیاز لطفا به ادمین پیام ارسال کنید 😑😂',
    ...
    'customer_custome_plan_name'=>'اسم کانفیگ رو وارد کن ( فقط حروف انگیلیسی و عدد باهم وارد کنید )',
    'send_user_id'=>"🀄️| آیدی عددی کاربر رو بفرس :",
    'enter_decrease_amount'=>"💸 | مبلغی که میخوای کسر کنی رو وارد کن:",
    'enter_increase_amount'=>"💸 | مبلغی که میخوای اضافه کنی رو وارد کن:",
    'user_not_found'=>"🥴 | همچین یوزری در دیتابیس وجود ندارد",
    ...
    'increase_wallet_cart_to_cart'=>"♻️ لطفا یه تصویر از فیش واریزی ارسال کنید :
...
",
    'out_of_connection_capacity'=>'ظرفیت این سرویس پر شده است',
    'out_of_server_capacity'=>'ظرفیت این سرور پر شده است',
    'can_create_specific_account'=> "روی این پلن فقط AMOUNT اکانت میشه ساخت",
    'buy_account_cart_to_cart'=>"♻️ لطفا  یه تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده رو در یک پیام برام ارسال کن :

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

✅ بعد از اینکه پرداختت تایید شد ( لینک سرور ) به صورت خودکار از طریق همین ربات برات ارسال میشه!",
    'renew_ccount_cart_to_cart'=>"♻️ لطفا یه تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده رو در یک پیام برام ارسال کن :
...
",
    ...
    'you_dont_have_config'=>'هیچ سفارشی نداری 🙁 باید یه کانفیگ خریداری کنی',
...
",
    ...
    'send_only_number'=> "⚠️ |  اشتباه ❗️ لطفا فقط عدد ارسال کنید",
    ...
    'start_message'=>'سلام به ربات وی اس پی ان خوش اومدی
    
پروتکل تانل داخلی و سرور های ما کاملا اختصاصی هست ❤️

📡 رکوردار بیشترین سرعت اینترنت بین الملل
✅ بازگشت پول در صورت نارضایتی
☎️ پشتیبانی 24 ساعته تا روز آخر 

🚪 /start',
    'new_member_joined'=>"📢 | یه ممبر جدید عضو ربات شد :

نام و نام خانوادگی: FULLNAME
نام کاربری: @USERNAME
آیدی عددی: USERID

در صورت نیاز پیام ارسال کنید ",
    "not_joine_yet"=>"هنوز که عضو کانال نشدی",
    'insert_discount_code'=>"🎁|کد تخفیف تو را وارد کن:",
    "not_valid_discount_code"=>"‼️|کد تخفیفی که وارد کردی معتبر نیس",
...
⁮⁮ ⁮⁮",
    ...
    'agency_request_declined'=>"⛔️ درخواست شما برای نمایندگی رد شده",
...
مدت زمان سرویس: DAYS روز',
    ...
    'incorrect_config_name'=>"❗️|اسم وارد شده معتبر نمی باشد",
    'pay_with_tron_wallet'=>"♻️ مبلغ AMOUNT ترون رو به والت زیر ارسال کن و تکسید آیدی واریزی ترون رو برام ارسال کن :
